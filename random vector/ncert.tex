...
\author{ Ajay%$^{*}$% <-this % stops a space
...
$\vec{A}$ = \myvec{2\\-1} , $\vec{B}$ = \myvec{-3\\4} , $\vec{C}$ = \myvec{1\\2}
\section{Vector}
...
\begin{table}[!ht]
	...
	\label{tab33:equations_altitude}	
\end{table}
\subsection{Figure}
\begin{figure}[!ht]
	\centering
	...
	\label{fig33:Triangle_with_altitude}	
\end{figure}
...
\begin{table}[!ht]
	...
	\label{tab33:equations_circumcenter}	
\end{table}
\subsection{Figure}
\begin{figure}[!ht]
	\centering
	\includegraphics[width=\columnwidth]{figs/figure_5.png}
	\caption{Triangle with circumcircle generated using python}
	\label{fig33:Triangle_with_circumcircle}	
\end{figure}
...
\begin{table}[!ht]
	...
	\label{tab33:equations_incircle}	
\end{table}
\subsection{Figure}
\begin{figure}[!ht]
	\centering
	...
	\label{fig33:Triangle_with_incircle}	
\end{figure}
